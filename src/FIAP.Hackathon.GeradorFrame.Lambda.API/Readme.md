...
Execute unit tests
```
    cd "FIAP.Hackathon.GeradorFrame.Lambda.API/test/FIAP.Hackathon.GeradorFrame.Lambda.API.Tests"
    dotnet test
```

Deploy application
```
    cd "FIAP.Hackathon.GeradorFrame.Lambda.API/src/FIAP.Hackathon.GeradorFrame.Lambda.API"
